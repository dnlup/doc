...
var validate = (function() {
  ...
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    ...
    if ((data && typeof data === "object" && !Array.isArray(data))) {
      ...
      if (data.unref === undefined) data.unref = true;
      ...
      for (var key0 in data) {
        var isAdditional0 = !(false || key0 == 'sampleInterval' || key0 == 'autoStart' || key0 == 'unref' || key0 == 'eventLoopOptions' || key0 == 'collect');
        if (isAdditional0) {
          delete data[key0];
        }
      }
        ...
        if (valid1) {
          ...
          if (typeof data1 !== "boolean") {
            ...
            if (coerced1 === undefined) {
              validate.errors = [{
                keyword: 'type',
                dataPath: (dataPath || '') + '.autoStart',
                schemaPath: '#/properties/autoStart/type',
                params: {
                  type: 'boolean'
                },
              ...
              data1 = coerced1;
              data['autoStart'] = coerced1;
            }
          }
          var valid1 = errors === errs_1;
          if (valid1) {
            var data1 = data.unref;
            var errs_1 = errors;
            if (typeof data1 !== "boolean") {
              var dataType1 = typeof data1;
              var coerced1 = undefined;
              ...
              if (coerced1 === undefined) {
                validate.errors = [{
                  keyword: 'type',
                  dataPath: (dataPath || '') + '.unref',
                  schemaPath: '#/properties/unref/type',
                  params: {
                    type: 'boolean'
                  },
                  message: 'should be boolean'
