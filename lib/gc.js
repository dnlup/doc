...
const kFlagsEnabled = Symbol('kFlagsEnabled')
...
class GCAggregatedEntry extends GCEntry {
  constructor (flags) {
    super()
    this[kFlagsEnabled] = Boolean(flags)
    if (this[kFlagsEnabled] && gcFlagsSupported) {
      this[kFlags] = new Map([
...
class GCMetric {
  constructor ({
    ...
    console.log(aggregate, flags)
    this[kPause] = new GCEntry()
    if (aggregate) {
      this[kGCEntries] = new Map([
        [NODE_PERFORMANCE_GC_MAJOR, new GCAggregatedEntry(flags)],
        [NODE_PERFORMANCE_GC_MINOR, new GCAggregatedEntry(flags)],
        [NODE_PERFORMANCE_GC_INCREMENTAL, new GCAggregatedEntry(flags)],
        [NODE_PERFORMANCE_GC_WEAKCB, new GCAggregatedEntry(flags)]
      ])
    } else {
